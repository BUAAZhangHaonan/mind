...
| --- | --- | --- | --- | --- | --- |
| Qwen3-VL-8B | POPE popular | ROC 0.8462 [0.8228, 0.8696]; PR 0.1159 [0.0928, 0.1450] | ROC 0.8908 [0.8694, 0.9105]; PR 0.1741 [0.1375, 0.2168] | ROC 0.9145 [0.8946, 0.9331]; PR 0.2596 [0.1997, 0.3340] | ROC 0.8690 [0.8445, 0.8918]; PR 0.1470 [0.1153, 0.1842] |
| InternVL3.5-8B | POPE popular | ROC 0.8764 [0.8594, 0.8943]; PR 0.4284 [0.3685, 0.4939] | ROC 0.8978 [0.8810, 0.9140]; PR 0.5092 [0.4529, 0.5669] | ROC 0.9119 [0.8973, 0.9260]; PR 0.5333 [0.4740, 0.5936] | ROC 0.8929 [0.8764, 0.9092]; PR 0.4854 [0.4274, 0.5466] |
| LLaVA-OneVision-7B | POPE popular | not run | not run | not run | not run |
| Molmo-7B-D-0924 | POPE popular | not run | not run | not run | not run |
...
Popular feature-ablation rows are only available for Qwen and InternVL in the saved round-two decision artifact. LLaVA and Molmo popular ablation rows were not saved.
